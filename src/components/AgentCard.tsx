  ...
  return (
    <motion.div 
      ...
      className={cn(
        ...
        isMainAgent 
          ? "bg-gradient-to-br from-yellow-950/90 via-yellow-900/50 to-yellow-950/90 border-yellow-500/50 shadow-[0_0_30px_rgba(255,255,0,0.3)]" 
          : "bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-gray-900/90 border-yellow-500/20",
        "hover:shadow-[0_0_30px_rgba(255,255,0,0.2)]"
      )}
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-bold text-lg tracking-tight bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-200 bg-clip-text text-transparent">
            {name}
          </h3>
        </div>
        <motion.div 
      ...
      <p className="text-sm text-yellow-200/60 font-medium mb-3">
        {role}
      </p>
      <Tooltip>
